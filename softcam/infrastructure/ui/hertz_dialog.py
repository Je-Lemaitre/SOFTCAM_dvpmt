...
class Ui_HertzDialog(object):
    ...
    def retranslateUi(self, HertzDialog):
        ...
        self.contactLabel.setText(QCoreApplication.translate("HertzDialog", u"<html><head/><body><p align=\"center\">Contact</p></body></html>", None))
        self.contactComboBox.setItemText(0, QCoreApplication.translate("HertzDialog", u"Came/Soupape", None))
        self.contactComboBox.setItemText(1, QCoreApplication.translate("HertzDialog", u"Came/Patin", None))
        self.contactComboBox.setItemText(2, QCoreApplication.translate("HertzDialog", u"Soupape/Patin", None))
    ...
    def populateUi(self):
        ...
        self.staticPlotWidget.setYRange(0, 1500)
        ...
        self.contact1_staticCurve = pg.PlotDataItem(pen=pg.mkPen(color='b', width=2))
        self.staticPlotWidget.addItem(self.contact1_staticCurve)
        self.contact2_staticCurve = pg.PlotDataItem(pen=pg.mkPen(color='g', width=2))
        self.staticPlotWidget.addItem(self.contact2_staticCurve)
        ...
        self.usespeedPlotWidget.setYRange(0, 1500)
        ...
        self.floatspeedPlotWidget.setYRange(0, 1500)
